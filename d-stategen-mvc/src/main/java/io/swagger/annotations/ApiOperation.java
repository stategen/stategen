...
public @interface ApiOperation {
    ...
    /**
     * A list of tags for API_PATH documentation control.
     * <p>
     ...
     * and used: {@code @GET}, {@code @HEAD}, {@code @POST}, {@code @PUT}, {@code @DELETE_IF_EXIST} and {@code @OPTIONS}.
     ...
     * <p>
     * Acceptable values are "GET", "HEAD", "POST", "PUT", "DELETE_IF_EXIST", "OPTIONS" and "PATCH".
     */
     ...
     * <p>
     * Takes in comma-separated values of content types.
     * For example, "application/json, application/xml" would suggest this API_PATH Resource
