...
<tr>
	...
	<td>与任务类型匹配的名称例如：1、任务管理中配置的任务名称(对应Schedule) 2、Class名称(对应java) 3、Bean的名称(对应Bean),
	         如:demoTaskBean$ownSign ,ownSign会作为参数传入selectTasks
	</td>
</tr>
<tr>
	<td>任务参数:</td>
...
<tr>
	...
	<td><input type="text" name="assignNum" value="1"  width="30"></td>
	<td>所有服务器总共运行的最大数量,建议只要 1 个线程</td>
</tr>
<tr>
	<td>IP地址(逗号分隔)：</td>
	<td><input type="text" name="ips" value="<%=ips%>" width="30"></td>
	<td>127.0.0.1或者localhost会在所有机器上运行,建议指定集群中的某一台机器</td>
</tr>
</table>
<br/>
