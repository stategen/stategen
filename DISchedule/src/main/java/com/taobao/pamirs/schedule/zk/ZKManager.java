...
public class ZKManager{
    ...
    public enum keys {
        ...
        rootPath("/taobao-pamirs-schedule/huijin"), 
        userName("ScheduleAdmin"), password("password"), zkSessionTimeout("60000"),isCheckParentPath("true");
    ...
    protected static void putKeysToProperties(Properties properties,keys key){
        properties.put(key.toString(), key.defaultValue);
    }
	   
	public static Properties createProperties(){
		Properties result = new Properties();
		for (keys key : keys.values()) {
		    putKeysToProperties(result,key);
        }
		return result;
	}
